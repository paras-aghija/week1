...
template sudoku() {
    ...
    component r1[9][9] = RangeProof(4);
    component r2[9][9] = RangeProof(4);


    
    for (var i=0; i<9; i++) {npm 
        for (var j=0; j<9; j++) {
            ...
            r1[i][j].in <== puzzle[i][j];
            r1[i][j].range[0] <== 0;
            r1[i][j].range[1] <== 9;
            assert(r1[i][j].out); //[assignment] change assert() to use your created RangeProof instead
            ...
            r2[i][j].in <== solution[i][j];
            r2[i][j].range[0] <== 0;
            r2[i][j].range[1] <== 9;
            assert(r2[i][j].out); //[assignment] change assert() to use your created RangeProof instead
